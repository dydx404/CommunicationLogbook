...
\title{Communications Lab 1 - Intro to LabView}
\date{}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{front_panel.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{block_diagram_2.png}
    \caption{Block diagram for Exercise 2 initial implementation}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{frontpanel_2.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ex2_histogram_1000iters.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ex2_standard_normal.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ex3_blockdiagram.png}
    \caption{Block diagram of the AM modulator implementation}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ex3_frontpanel_task1.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ex3_mu_0_5.png}
    \caption{Time-domain and PSD plots for $\mu=0.5$}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ex3_mu_1.png}
    \caption{Time-domain and PSD plots for $\mu=1$}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ex3_mu_1_5.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ex3_fm_1k.png}
    \caption{Time-domain and PSD plots for $f_m=1\,\text{kHz}$}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ex3_fm_2k.png}
    \caption{Time-domain and PSD plots for $f_m=2\,\text{kHz}$}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{ex3_fm_5k.png}
